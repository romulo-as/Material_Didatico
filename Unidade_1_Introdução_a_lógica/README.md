...
e mostrar alguns exemplos de linguagens orientada a objetos.
...
Dica: Crie uma pasta chamada "ws-eclipse" ou com nome parecido para sempre estar salvando seus projetos criados no eclipse, para que não misture com projetos de outra IDE que possa vir a utilizar, mantendo, assim, sua organização.
